...
const CodeEditor = () => {
  ...
  const [loading, setLoading] = useState(false); // For running code
        ...
        >
          <div>
            <div style={{ height: "120vh", overflow: "auto" }}>
              <div
                className="me-3 p-3 border rounded bg-light"
            ...
            {/* Sidebar component inside que area */}
            {isSidebarVisible && (
              <div
            ...
            >
              ...
              <div className="col-md-4">
                <div style={{ float: "right" }}>
                  ...
                  <button className="btn btn-success btn-md mt-4 shadow-lg hover-shadow">
                    Submit
                  </button>
                </div>
              </div>
