          ...
          >
                ...
                >
                  ...
                  <li class="sidebar-menu-item">
                    ...
                    >
                      ...
                      <span class="sidebar-menu-badge badge badge-accent badge-notifications ml-auto">
                        PRO
                      </span>
                    </a>
                  </li>
            ...
            <ul class="sidebar-menu">
              <li class="sidebar-menu-item active open">
                ...
                <ul
                  class="sidebar-submenu collapse show sm-indent"
                  id="components_menu"
                >
                  <li class="sidebar-menu-item">
              ...
              <li class="sidebar-menu-item">
                ...
                >
                  <li class="sidebar-menu-item">
                    <a
                      class="sidebar-menu-button"
                      href="https://luma.humatheme.com/Demos/Compact_App_Layout/ui-forms.html"
                    >
                  ...
                  <li class="sidebar-menu-item">
                    <a
                      class="sidebar-menu-button"
                      href="https://luma.humatheme.com/Demos/Mini_App_Layout/ui-forms.html"
                    >
                  ...
                  <li class="sidebar-menu-item">
                    <a
                      class="sidebar-menu-button"
                      href="https://luma.humatheme.com/Demos/Mini_Secondary_Layout/ui-forms.html"
                    >
                  ...
                  <li class="sidebar-menu-item">
                    <a
                      class="sidebar-menu-button"
                      href="https://luma.humatheme.com/Demos/Boxed_App_Layout/ui-forms.html"
                    >
                  ...
                  <li class="sidebar-menu-item">
                    <a
                      class="sidebar-menu-button"
                      href="https://luma.humatheme.com/Demos/Sticky_App_Layout/ui-forms.html"
                    >
                  ...
                  <li class="sidebar-menu-item">
                    <a
                      class="sidebar-menu-button"
                      href="https://luma.humatheme.com/Demos/Fixed_Layout/ui-forms.html"
                    >
